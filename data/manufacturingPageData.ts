...
export const manufacturingProblem = {
  ...
  cards: [
    { icon: `${ICON_ROOT}/problem-1.png`, title: "Disconnected Processes", description: "Your BOM is in one system, work orders in another, inventory in a third. Nothing connects the three." },
    { icon: `${ICON_ROOT}/problem-2.png`, title: "No Assembly Visibility", description: "You see the finished product on the schedule, but not where each component work order actually stands." },
    { icon: `${ICON_ROOT}/problem-3.png`, title: "Manual Component Tracking", description: "Every sub-assembly and task gets tracked by hand on spreadsheets and whiteboards. It breaks as volume grows." },
    { icon: `${ICON_ROOT}/problem-4.png`, title: "Inventory Runs Short Mid-Build", description: "Nobody confirms material availability until production stalls. The shortage surfaces after the work order has already started." },
    { icon: `${ICON_ROOT}/problem-5.png`, title: "Dependencies Cause Delays", description: "Final assembly waits on a component nobody flagged as late. One missed dependency stalls the entire build." },
  ],
};
...
export const manufacturingBetterWay = { heading: fsmBetterWayHeading, description: fsmBetterWayDescription, leftTitle: fsmBetterWayLeftTitle, rightTitle: fsmBetterWayRightTitle, leftItems: fsmRigidToolsItems, rightItems: fsmCustomBuildItems, footerItems: fsmBetterWayFooterItems };
...
export const manufacturingRealOperations = { heading: fsmRealOpsHeading, challengeQuote: fsmRealOpsChallengeQuote, challengeBullets: fsmRealOpsChallengeBullets, metricsDescription: fsmRealOpsMetricsDescription, metrics: fsmRealOpsMetrics, footerQuote: fsmRealOpsFooterQuote, solutionItems: fsmRealOpsSolutionItems };
