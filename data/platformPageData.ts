export const platformSectionNavItems = [
  { id: "platform-reality", label: "Built For Operational Reality" },
  { id: "platform-backbone", label: "One Backbone" },
  { id: "platform-capabilities", label: "Core Capabilities" },
  { id: "platform-start-fast", label: "Start Fast" },
  { id: "platform-multi-systems", label: "Multiple Systems" },
  { id: "integrations", label: "Integrations" },
];

export const platformHeroBullets = [
  "Ready systems, not blank templates",
  "Configurable workflows, approvals, and dashboards",
...
export const platformStartFastHeading =
  "Start Fast. Configure Around Reality. Keep Improving.";
export const platformStartFastSteps = [
  {
    title: "Choose the Starting System",
    description:
      "Begin With FSM, CRM, ITSM, Field Sales, Or Process Management.",
    active: true,
  },
  {
    title: "Map Your Workflow",
    description:
      "Identify How Work Actually Moves Across Teams, Approvals",
    active: true,
  },
  {
    title: "Configure and Go Live",
    description: "Adapt Workflows, Forms, Dashboards, And Rules Without",
    active: false,
  },
  {
    title: "Keep Adapting",
...
export const platformLivingServiceHeading =
  "Software Should Keep Fitting- Even After Go-Live";
export const platformLivingServiceDescription =
  "Real Workflows Change After Teams Start Using The System. New Rules Appear. New Approvals Get Added. New Teams Join. New Exceptions Come Up.";
export const platformLivingServiceSidebar = [
  "Real-Time Visibility",
  "Automated Operational Flows",
  "Workflow Coordination",
];
export const platformLivingServiceStages = [
  { id: "deploy", label: "Deploy lorem is", active: false },
  { id: "use", label: "Use lorem is", active: true },
  { id: "adapt", label: "Adapt lorem is", active: false },
  { id: "optimize", label: "Optimize lorem is", active: false },
];

export const platformBusinessTabs = [
  "Field Service Businesses",
  "Manufacturing & Process",
  "Growing SMB Operations",
  "Internal Operations Teams",
  "Field Sales Teams",
] as const;

export type PlatformBusinessTab = (typeof platformBusinessTabs)[number];

export const platformBusinessTabContent: Record<
  PlatformBusinessTab,
  {
    eyebrow: string;
    title: string;
...
> = {
  "Field Service Businesses": {
    ...
    features: [
      "Fits Your Workflow",
      "Your System Adapts To How You Work Start",
    ],
    cta: "Get Started Now",
  },
  "Manufacturing & Process": {
...
export const platformImproveFeatures: {
  title: string;
  description: string;
...
}[] = [
  {
    ...
    description:
      "Your System Adapts To How Not From Scratch Lorem Ipsum",
    align: "left",
  },
  {
...
export const platformFeatureGridCards = [
  {
    title: "Cloud-Ready Foundation",
    description:
      "Built To Support Scalable Business Workflows. Your System Adapts To How Not From Scratch Lorem Ipsum",
    tags: ["Lorem ipsum", "Lorem ipsum is", "Lorem ipsum is"],
  },
  {
    title: "Execution Control",
    description:
      "Built To Support Scalable Business Workflows. Your System Adapts To How Not From",
    stats: [
  ...
  },
  {
    ...
    description:
      "Built To Support Scalable Business Workflows. Your System Adapts To How Not From Scratch Lorem Ipsum",
    listItems: ["Automated Operational Flows", "Workflow Coordination"],
  },
];
