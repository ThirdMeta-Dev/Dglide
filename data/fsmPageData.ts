...
export const fsmWorkflowTimelineItems = [
  { icon: "/solutions/workflow-change/faster-resolution.svg", title: "Faster Service Response", description: "Requests reach the right technician in minutes, not after rounds of calls.", width: 620 },
  { icon: "/solutions/workflow-change/realtime-visibility.svg", title: "Better Technician Productivity", description: "Field teams know what to do, where to go, and what to update.", width: 581 },
  { icon: "/solutions/workflow-change/sla-control.svg", title: "Real-Time Operational Visibility", description: "See every job's status as it happens, with no chasing for updates.", width: 581 },
  { icon: "/solutions/workflow-change/less-manual.svg", title: "Stronger SLA Control", description: "Track every deadline and escalate before a breach, not after.", width: 610 },
  { icon: "/solutions/workflow-change/beyond-ticketing.svg", title: "Improved Customer Experience", description: "Faster, more reliable service your customers actually notice.", width: 664 },
  { icon: "/solutions/workflow-change/better-service.svg", title: "Less Manual Coordination", description: "Work moves itself between stages, so your team stops chasing.", width: 740 },
];

// FSM What Improves
export const fsmImprovesHeading = "What Improves With DGlide FSM";
export const fsmImprovesFeatures = [
  { title: "Faster Service Response", description: "Requests reach the right technician fast, so jobs start sooner and customers wait less.", align: "left" as const, icon: "/solutions/what-improves/icon-faster-service-response.svg" },
  { title: "Better Technician Productivity", description: "Field teams know what to do and where to go, so they finish more jobs a day.", align: "center" as const, icon: "/solutions/what-improves/icon-real-time-visibility.svg" },
  { title: "Real-Time Operational Visibility", description: "See every job's status as it happens, so nothing stalls unseen or gets forgotten.", align: "right" as const, icon: "/solutions/what-improves/icon-stronger-sla-control.svg" },
  { title: "Stronger SLA Control", description: "Track every deadline automatically and escalate before a breach, protecting the contracts you depend on.", align: "left" as const, icon: "/solutions/what-improves/icon-less-manual-coordination.svg" },
  { title: "Improved Customer Experience", description: "Faster, more reliable service builds the trust that keeps customers and contracts renewing.", align: "center" as const, icon: "/solutions/what-improves/icon-workflows-beyond-ticketing.svg" },
  { title: "Less Manual Coordination", description: "Work moves itself between stages, so your team stops chasing updates and approvals.", align: "right" as const, icon: "/solutions/what-improves/icon-better-service-experience.svg" },
];
...
export const fsmGoLiveCards = [
  { step: "01", title: "Understand Your Service Workflow", description: "Map your requests, work orders, technicians, SLAs, and closure rules.", icon: "/solutions/go-live/icon-1.svg", offsetTop: 0, cardHeight: 280, shadow: false },
  { step: "02", title: "Configure the FSM System", description: "Adapt forms, workflows, approvals, and dashboards to how you work.", icon: "/solutions/go-live/icon-2.svg", offsetTop: 40, cardHeight: 260, shadow: true },
  { step: "03", title: "Train Your Teams", description: "Prepare supervisors, service managers, and technicians to run it.", icon: "/solutions/go-live/icon-3.svg", offsetTop: 80, cardHeight: 240, shadow: true },
  { step: "04", title: "Go Live", description: "Start running real service operations inside DGlide.", icon: "/solutions/go-live/icon-4.svg", offsetTop: 120, cardHeight: 220, shadow: true },
  { step: "05", title: "Keep Improving", description: "Use LSM to refine workflows after real usage begins.", icon: "/solutions/go-live/icon-5.svg", offsetTop: 160, cardHeight: 200, shadow: true },
];
