...
export default function ScheduleDemoPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ display: "flex", gap: 68, alignItems: "flex-start" }}>
          ...
          <div style={{ flex: "0 0 530px", display: "flex", flexDirection: "column", gap: 38 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
              ...
              >
                One System To Run<br />Your Whole Operation
              </h1>

              {/* Description */}
              <p style={{ fontFamily: "Inter, sans-serif", fontSize: 16, fontWeight: 400, lineHeight: "160.8%", color: "#555", margin: 0 }}>
                No long forms. Tell us how you run things in 30 seconds, and we will show you DGlide built around it.
              </p>
          ...
          <div style={{ flex: 1, background: "#FFF", borderRadius: 16, padding: "32px 40px", boxShadow: "0 4px 32px rgba(0,0,0,0.08)", display: "flex", flexDirection: "column", gap: 24 }}>
            ...
            {submitted ? (
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: 480, gap: 20, textAlign: "center" }}>
                ...
                <h2 style={{ fontFamily: "var(--font-tasa-orbiter)", fontSize: 28, fontWeight: 400, color: "#000", margin: 0 }}>Demo Booked!</h2>
                <p style={{ fontFamily: "Inter, sans-serif", fontSize: 16, color: "#6F7276", lineHeight: "28px", maxWidth: 360, margin: 0 }}>
                  We&apos;ll reach out within 1 business day to confirm your walkthrough slot.
                </p>
              </div>
            ) : (
              <>
                ...
                <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                  ...
                  <div style={{ width: "100%", background: "#F3F3F3", borderRadius: 12, padding: "16px 20px" }}>
                    <p style={{ fontFamily: "Inter, sans-serif", fontSize: 15, fontWeight: 400, lineHeight: "24px", color: "#222222", margin: 0, textAlign: "center" }}>
                      &ldquo;Hi, I&apos;m Vinayak from DGlide. Answer a couple of quick questions, and I&apos;ll tailor your demo.&rdquo;
                    </p>
                  </div>
                </div>
      ...
      {/* ── Who's Already Running on DGlide — single-row banner carousel ── */}
      <div style={{ background: "#F3F3F3", padding: "40px 0 48px" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 64px", display: "flex", alignItems: "center", gap: 60 }}>
          ...
          <div style={{ flexShrink: 0 }}>
            <p style={{ fontFamily: "var(--font-tasa-orbiter)", fontSize: 18, fontWeight: 400, lineHeight: "1.4", color: "#000", margin: 0 }}>Who&apos;s Already Running</p>
            <p style={{ fontFamily: "var(--font-tasa-orbiter)", fontSize: 18, fontWeight: 400, lineHeight: "1.4", color: "#000", margin: 0 }}>on DGlide</p>
          </div>
          {/* Scrolling pills */}
