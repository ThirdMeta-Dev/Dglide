...
const ctaData = {
  ...
  title: "Bring your last 20 visits. A 30-minute walkthrough shows what DGlide closes that UpTeams can't.",
    ...
    <section className={styles.hero}>
      <div className={styles.heroInner}>
        ...
        <ScrollReveal direction="up">
          <h1>
            <span>DGlide vs UpTeams:</span>
            <br />
            Proof of a Visit, or a Record of What It Solved?
          </h1>
        </ScrollReveal>

        <ScrollReveal direction="up" delay={0.08}>
          <p className={styles.heroSubtext}>
            UpTeams confirms your rep showed up. DGlide turns that same visit into a sales order, a
            service ticket, or a resolved complaint, tracked on one record instead of lost in a chat thread.
          </p>
        </ScrollReveal>
      ...
      <div className={styles.container}>
        <ScrollReveal direction="up">
          <h2 className={`${styles.sectionTitle} ${styles.sectionTitleSmall}`}>
            What DGlide Does That UpTeams Doesn&apos;t
          </h2>
        </ScrollReveal>
      ...
      <div className={styles.container}>
        <div className={styles.splitHeading}>
          <ScrollReveal direction="left">
            <h2 className={styles.sectionTitle}>Choose by What Happens After the Visit</h2>
          </ScrollReveal>
          <ScrollReveal direction="right">
            <p>Two different jobs. Here is where DGlide earns the demo, and where UpTeams still gets it right.</p>
          </ScrollReveal>
        </div>
      ...
      <div className={styles.container}>
        <ScrollReveal direction="up">
          <div className={styles.centerHeading}>
            ...
            <p>A closer look at where an operations platform outruns a visit-tracking app, with the mechanics behind each difference.</p>
          </div>
        </ScrollReveal>
      ...
      <div className={styles.container}>
        <div className={styles.comparisonStickyHeader} data-comparison-sticky-header>
          <div className={styles.comparisonHeading}>
            <ScrollReveal direction="up">
              <h2 className={styles.sectionTitle}>DGlide vs UpTeams Full Comparison</h2>
            </ScrollReveal>
            <ScrollReveal direction="up" delay={0.06}>
              <p>The complete matrix, including the rows UpTeams wins. &quot;Not listed&quot; means the capability isn&apos;t published anywhere on the vendor&apos;s site as of Aug 2026.</p>
            </ScrollReveal>
          </div>
        ...
        <p className={styles.comparisonFootnote}>
          UpTeams pricing and features verified on upteams.com, August 2026. DGlide platform capabilities
          verified on dglide.com. DGlide does not publish per-seat pricing; get a scoped quote for a direct
          cost comparison at your headcount.
        </p>
      </div>
    </section>
  );
    ...
    <section className={styles.valueCardsSection}>
      <div className={`${styles.container} ${styles.valueCards}`}>
        <article className={`${styles.valueCard} ${styles.valueCardPrimary}`}>
          ...
          <p>When a field visit turns into a tracked ticket instead of a phone call, distributor complaints get assigned and resolved faster instead of sitting in a chat thread.</p>
          <Link href="/schedule-demo" className="dg-btn-outline">Get a Demo <Arrow /></Link>
        </article>
